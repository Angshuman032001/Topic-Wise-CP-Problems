/*
For all those edges which are not a part of MST, find the heaviest edge in the simple path from edge.from to edge.to in the MST.
answer will be MSTCost - heaviestEdgeWeight + currentEdgeWeight;
*/
